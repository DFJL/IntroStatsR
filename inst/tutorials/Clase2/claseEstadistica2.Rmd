---
title: "Clase 2:Medidas de variabilidad y tipos de variables"
output: 
  learnr::tutorial:
    progressive: true
    allow_skip: true
...
theme: united
description: >
  Clase 2 del curso de Introducción a la Estadística con R.
  Incluye los temas de análisis de variabilidad y tipos de variables estadísticas.
---
...
sd(covidCantones$Recovered)/mean(covidCantones$Recovered)*100
```
...
cantonesAgrupado2 <- covidCantones %>% # Primero creamos un dataframe copia del df cargado.
  ...
  summarise(CasesT= sum(Cases,na.rm = TRUE),
            RecoveriesT = sum(Recovered,na.rm = TRUE),
            sdCases= sd(Cases,na.rm = TRUE),
            sdRecoveries = sd(Recovered,na.rm = TRUE),
